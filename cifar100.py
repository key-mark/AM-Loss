...
from loss import SCELoss, AELoss, FocalLoss, SparsemaxLoss, LabelSmoothSoftmax, ScaledSoftmaxLoss, HingeLoss
...
CIFAR_PATH = "E:\python\ResNet-18-cifar10"
...
trainloader = torch.utils.data.DataLoader(cifar100_training, batch_size=BATCH_SIZE, shuffle=True, num_workers=num_workers)
...
# 定义损失函数和优化方式
#criterion = AELoss(num_classes=100) #损失函数为AELoss
criterion = HingeLoss()
